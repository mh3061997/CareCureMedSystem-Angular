...
export class DoctorsComponent implements OnInit {
  ...
  DentalArr:any =[{name:'Dr. Amani Yasser',speciality:'Dentist',bio:'Assistant lecturer in Ain Shams University',img:'../../../../assets/Doctors/Dental/Dr. Amani Yasser-Dentist-Assistant lecturer in Ain Shams University -.png'},
